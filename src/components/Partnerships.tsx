    ...
    >
      <Box ref={ref} sx={{ maxWidth: 1200, mx: 'auto' }}>
        ...
        <Box sx={{ mb: { xs: 8, md: 10 }, textAlign: 'center' }}>
          ...
          >
            Trabalhos{' '}
            <Box component="span" sx={{ color: 'primary.main' }}>Realizados</Box>
          </Typography>
          <Typography
            variant="body2"
            sx={{
          ...
          >
            Parcerias com marcas do segmento — use o cupom exclusivo para aproveitar condições especiais.
          </Typography>
        </Box>
          ...
          {partnerships.map((p, i) => (
            ...
            >
              ...
              <Box sx={{ p: { xs: 3, md: 4 }, display: 'flex', flexDirection: 'column', flex: 1 }}>
                ...
                <Tooltip
                  title={copied === p.brand ? 'Cupom copiado!' : 'Toque para copiar o cupom'}
                  placement="top"
                >
                  <Box
                    ...
                    sx={{
                      ...
                      gap: 1.5,
                      border: '1px solid',
                      borderColor: copied === p.brand ? 'success.main' : 'rgba(201,168,76,0.4)',
                      borderRadius: '6px',
                      px: 2,
                      py: 1.25,
                      mb: 3,
                      alignSelf: 'flex-start',
                      backgroundColor: copied === p.brand
                        ? 'rgba(76,175,80,0.08)'
                      ...
                      minHeight: 44,
                      '&:hover': {
                        borderColor: copied === p.brand ? 'success.main' : 'primary.main',
                        backgroundColor: copied === p.brand
                          ? 'rgba(76,175,80,0.12)'
